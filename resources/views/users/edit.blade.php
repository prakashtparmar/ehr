                                    ...
                                    @foreach ($roles as $value => $label)
                                       <label style="margin-right: 15px;">
                                          <input type="checkbox" name="roles[]" value="{{ $value }}"
                                             {{ in_array($value, old('roles', $userRole)) ? 'checked' : '' }}>
                                          {{ $label }}
                                       </label>
                                    @endforeach
                                 </div>
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 @if($user->image)
                                    <img src="{{ asset($user->image) }}" height="80" class="mt-2">
                                 @endif
                              </div>
                           </div>
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <textarea name="address" class="form-control" rows="2" placeholder="Address">{{ old('address', $user->address) }}</textarea>
                              </div>
                           </div>
                        </div>
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="emergency_contact_no" class="form-control"
                                    placeholder="Emergency Contact" value="{{ old('emergency_contact_no', $user->emergency_contact_no) }}">
                              </div>
                           </div>
                        </div>
