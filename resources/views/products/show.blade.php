                ...
                <div class="page-content">
                    <div class="page-header">
                        <h1>
                            ...
                            @can('product-print')
                            {{-- PRINT BUTTON --}}
                            <button class="btn btn-success btn-sm pull-right" style="margin-right:10px;"
                                onclick="window.open('{{ route('products.pdf', $product->id) }}', '_blank')">
                                <i class="fa fa-file-pdf-o"></i> Print / Download PDF
                            </button>
                            @endcan
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">{{ $product->IdentificationMark }}</td>
                                    </tr>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">{{ $product->Prev_Occ_History }}</td>
                                    </tr>
                                </tbody>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">{{ $product->ColourVision }}</td>
                                    </tr>
                                </tbody>
